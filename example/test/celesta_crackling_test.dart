...
void main() {
  ...
  group('Celesta_minimal.sf3 Crackling Investigation', () {
    ...
    test('Plays rapid notes on Celesta_minimal.sf3 and analyzes frame deltas for clicks', () async {
      ...
      for (final note in notes) {
        ...
        print('Note $note: peak amplitude = ${peak.toStringAsFixed(4)} (handles: ${voice.handles.length})');
      }
